...
4. Taxonomy assignment using DADA2 and SILVA 138.2
...
!!! info
    ...
    Not necessary within the Diener Lab. Will use the references in our lab folder.

`cd` into your work directory, then

```bash
mkdir -p refs
wget https://zenodo.org/records/14169026/files/silva_nr99_v138.2_toGenus_trainset.fa.gz?download=1 -O refs/silva_nr99_v138.2_toGenus_trainset.fa.gz
wget https://zenodo.org/records/14169026/files/silva_v138.2_assignSpecies.fa.gz?download=1 -O refs/silva_v138.2_assignSpecies.fa.gz
```
